        ...
        <div v-for="product in products.data" :key="product.id">
            ...
            <div class="flex items-start justify-between gap-2 px-2">
                ...
                <div class="flex flex-col items-end">
                    ...
                    <span class="font-bold text-gray-600 lg:text-lg dark:text-white">{{ product.price }}Bs.</span>
                    <span class="text-sm text-red-500 line-through">{{ product.sellingprice }}Bs.</span>
                </div>
            </div>
        </div>
    </div>
